...
def main():
    ...
    if leaderstatus==1:
        ...
        print("Received From first Follower Node")
        count_words_s1=Counter(receive_s1)
        print("Most common words in first Follower Node")
        print(count_words_s1.most_common(3))
        receive_s2=json.loads(receive_s2json)
        print("Received from second Follower Node")
        count_words_s2=Counter(receive_s2)
        print("Most common words in second Follower Node")
